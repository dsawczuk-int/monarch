...
// oneCCL unique ID is 4096 bytes (vs NCCL's 128)
#define NCCL_UNIQUE_ID_BYTES 4096
typedef struct {
...
// C API wrapper functions - same signatures as NCCL but backed by oneCCL
// Streams are xpuStream_t (void*) pointers to SYCL queues
